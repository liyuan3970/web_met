    ...
    var openDialog = function (dataajax) {
      ...
      return editor.windowManager.open({
          ...
          items: [
            {
              ...
              name: 'checkpng', // identifier
              label: '宣传二维码', // text for the label
        ...
        onSubmit: function (api) {
          ...
          // 将输入框内容插入到内容区光标位置
          if (data.checkpng){
            editor.insertContent(html_png + data.SelectMode);
            api.close();
          }
          else{
